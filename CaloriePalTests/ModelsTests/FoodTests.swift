...
class FoodTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        food = Food(id: 1, name: "Chicken Noodle", nutrient: Nutrient(fat: 1.5, satFat: 1, cholesterol: 12.2, sodium: 473.9, carbs: 12.6, fiber: 1.9, sugars: 1.4, protein: 9), caloriePerUnit: 100, amount: FoodAmount(unit: "cup", amount: 1, multiplier: 1), type: .drink)
    }
